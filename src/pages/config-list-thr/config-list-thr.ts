...
@IonicPage()
@Component({
  selector: "page-config-list-thr",
  templateUrl: "config-list-thr.html"
})
export class ConfigListThrPage {
  ...
  constructor(
    ...
    //   reqObj.nfcNo = nfcNum;
    //   this.httpReq.get(
    //     "home/a/oldfolksinfo/homeOldFolksInfo/getByNfcNo",
    //     reqObj,
    //     data => {
  ...
  public openModal(pageName: string, obj?: any) {
    console.log("打开弹出层");
    const paramObj = ParamService.getParamObj(); // 获取参数
    if (obj) {
      paramObj.serverItemCode = obj.serverItemCode;
      paramObj.billingMethod = obj.billingMethod;
      console.log(paramObj);
      ParamService.setParamObj(paramObj); // 保存参数
